...
ifeq ($(config),release)
  OBJDIR     = ../../../../Output/Targets/Linux-x86-32/Release/obj/quake-gles1
  TARGETDIR  = ../../../../Output/Targets/Linux-x86-32/Release/bin
  TARGET     = $(TARGETDIR)/quake-gles1
  DEFINES   += -D_GNU_SOURCE=1 -DEGLW_GLES1
  ...
  LDDEPS    +=
  LIBS      += $(LDDEPS) -lm -ldl -lGLESv1_CM -lEGL -lSDL2main -lSDL2 -lwayland-egl
  # -lX11
...
ifeq ($(config),debug)
  OBJDIR     = ../../../../Output/Targets/Linux-x86-32/Debug/obj/quake-gles1
